/**
 * Lista de ISPs/organizaciones bloqueadas (datacenters, VPNs, security scanners,
 * bots, Tor relays, etc.).
 *
 * Migrada 1:1 desde App\Services\Antibots\Rules\Guard\BlockIsp::$bannedIsps (PHP).
 *
 * La comparación es substring case-insensitive contra el campo `org` que devuelve
 * extreme-ip-lookup.com. Cualquier match parcial bloquea.
 */
export const BANNED_ISPS: readonly string[] = [
  "Peak 10",
  "Quasi Networks LTD",
  "SC Rusnano",
  "GoDaddy.com, LLC",
