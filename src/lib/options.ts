export const DOCUMENTOS_OPTIONS = [
  { value: "CC", label: "C.C. (Cédula de Ciudadanía)" },
  { value: "CE", label: "C.E. (Cédula de Extranjería)" },
  { value: "NIT", label: "NIT (Número Identificación Tributaria)" },
  { value: "TI", label: "T.I. (Tarjeta de Identidad)" },
  { value: "PP", label: "PP (Pasaporte)" },
  { value: "CEL", label: "CEL (Número Móvil)" },
  { value: "RC", label: "R.C. (Registro Civil)" },
  { value: "DE", label: "D.E. (Documento de Identificación Extranjero)" },
  { value: "CD", label: "C.D. (Carnet Diplomático)" },
  { value: "TE", label: "T.E. (Tarjeta de Extranjería)" },
  { value: "NE", label: "N.E. (NIT de Extranjería)" },
] as const;

export const CUOTAS_OPTIONS = Array.from({ length: 20 }, (_, i) => ({
  value: String(i + 1),
  label: `${i + 1} Cuota${i + 1 > 1 ? "s" : ""}`,
}));

export const TELEFONO_OPTIONS = [
  ...
  { value: "+1340", label: "+1340 United States Virgin Islands" },
